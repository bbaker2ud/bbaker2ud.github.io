...
mapfile -t SINGLE < /root/GUACD/singleuserlist
mapfile -t MULTI < /root/GUACD/multiuserlist
mapfile -t HOMEORG < /root/GUACD/cashomeorglist
mapfile -t ORGNUMS < /root/GUACD/casorgnums
...
VALID=0
touch description
echo "Device"$(dmidecode -t1 | grep "Product Name:") > description &&
